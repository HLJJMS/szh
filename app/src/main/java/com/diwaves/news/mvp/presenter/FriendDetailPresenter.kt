...
@Inject
constructor(model: FriendDetailContract.Model, rootView: FriendDetailContract.View) :
    BasePresenter<FriendDetailContract.Model, FriendDetailContract.View>(model, rootView) {
    @Inject
