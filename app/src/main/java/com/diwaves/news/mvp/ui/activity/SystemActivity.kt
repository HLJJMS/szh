...
import com.diwaves.news.di.component.DaggerSystemComponent
 ...
 * }
 */
class SystemActivity : BaseActivity<SystemPresenter>(), SystemContract.View {
    ...
    override fun initView(savedInstanceState: Bundle?): Int {
        return R.layout.activity_system //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
